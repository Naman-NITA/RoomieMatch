    ...
    <footer className="bg-gradient-to-r from-purple-900 via-purple-800 to-pink-800 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold">RoomieMatch</span>
            </div>
            <p className="text-purple-100 mb-6 max-w-md">
              Find your perfect roommate with our intelligent matching system. Connect with like-minded people and
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-purple-100 hover:text-white transition-colors duration-300">
                  How it Works
                </a>
              </li>
              <li>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-purple-100">Verified profiles</p>
              </div>
            </div>
            <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-purple-100">10k+ users</p>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-purple-100">85% match success</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-purple-700 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-purple-100 text-sm">© {currentYear} RoomieMatch. All rights reserved.</p>
          <p className="text-purple-100 text-sm mt-2 md:mt-0">Made with ❤️ for better living experiences</p>
        </div>
      </div>
    </footer>
  )
